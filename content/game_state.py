...
## SPACESHIP ##
SPACESHIP_SPEED = 20
SPACESHIP_ANGULAR_VEL = 60
SPACESHIP_LIVES = 3

## BULLET ##
BULLET_MAX_SPEED = 50
BULLET_MAX_COOLDOWN = 500
BULLET_SCALE_FACTOR = 0.5

## BLACKHOLE ##
BLACKHOLE_READY = False
BLACKHOLE_SPEED = 10
BLACKHOLE_MAX_COOLDOWN = 5000
BLACKHOLE_LEFT_COOLDOWN = BLACKHOLE_MAX_COOLDOWN
BLACKHOLE_SCALE_FACTOR = 0.5
GRAVITY = 10

## ASTEROIDS ##
ASTEROID_MAX_SPEED = 15
ASTEROID_MAX_COOLDOWN = 1000
ASTEROID_MAX_SCALE_FACTOR = 1